package ru.artq.task.utility;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import org.junit.jupiter.api.Test;
import ru.artq.task.managers.ParserException;
...
import ru.artq.task.utility.gson_adapter.DurationAdapter;
import ru.artq.task.utility.gson_adapter.LocalDateAdapter;
...
class ParserTest {
    ...
    void parseTasksToStr() {
        ...
        assertEquals(TaskParser.parseFileToCSVString(new File("src/test/java/ru/artq/task/utility/test.csv")), List.of(
